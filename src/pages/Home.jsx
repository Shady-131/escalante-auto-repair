    ...
    <main>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="hidden md:flex flex-col items-center justify-center gap-4">
            <div className="relative">
              ...
              <div className="relative text-[9rem] select-none leading-none">🚗</div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {SERVICES.slice(0, 6).map(s => (
              ...
              >
                ...
                <p className="mt-3 text-brand-700 dark:text-red-400 font-bold text-sm">{s.price}</p>
              </div>
            ))}
          </div>
      ...
      <section className="bg-gray-50 dark:bg-gray-900 py-16 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            <span className="inline-flex items-center gap-1.5 bg-red-100 dark:bg-red-900/20
              text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800/40
